...
public class ForMain4 {
    public static void main(String[] args) {
        ...
        Stream<String> reversedStringStream = stringStream.transform(new Function<String, String>() {
            @Override
        ...
        // STEP7: Accumulation. In the same way we extract out the functionality
        // into a method like we did with transform().
        // What signature should it have?
        ArrayList<String> result = reversedStringStream.accumulate(new ArrayList<>(), new BiFunction<>() {
            @Override
            public ArrayList<String> apply(ArrayList<String> list, String item) {
                list.add(item);
                return list;
            }
        });
    ...
    public interface Stream<IN> {
        ...
        // STEP8: What's needed is: the accumulator, and a BiFunction
